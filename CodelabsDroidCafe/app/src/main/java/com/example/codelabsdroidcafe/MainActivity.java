...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_MESSAGE =
            "com.example.codelabsdroidcafe.extra.MESSAGE";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
       switch (item.getItemId()) {
           ...
           case R.id.action_status:
               displayToast(getString(R.string.menu_status_message));
               return true;

           case R.id.action_favorites:
               displayToast(getString(R.string.menu_favorites_message));
               return true;

           case R.id.action_contact:
               displayToast(getString(R.string.menu_contact_message));
               return true;
               default:
       }
